...
The 2026-09-19 fork survey is recorded in `docs/provenance/FORK_SURVEY.md`.

## Pinned early references
...
- hoverboardhavoc `gd32-pio-spl-package`, `8849cb2af35f16431734d9e9c101de648f54f061`: PlatformIO/GD32 SPL [standard peripheral library] clock-source reference.
